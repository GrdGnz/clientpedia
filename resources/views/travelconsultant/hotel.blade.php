  ...
  <div id="layoutSidenav_content">
      <main class="p-3">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
              <button class="nav-link txt-2" id="preferred-tab" data-bs-toggle="tab" data-bs-target="#preferred-tab-pane" type="button" role="tab" aria-controls="preferred-tab-pane" aria-selected="false">Preferred Hotels</button>
          </li>
        </ul>
