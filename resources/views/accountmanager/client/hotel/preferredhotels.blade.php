                        ...
                        <tbody>
                            @foreach ($preferredHotels as $preferred)
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('accountmanager.client.preferred_hotel.destroy', $preferred->id) }}" onsubmit="return confirm('Are you sure you want to delete this preferred airline?');">
                                            @csrf
                                            @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $('#editHotel').on('show.bs.modal', function (event) {
            ...
            modal.find('#editPreferredHotel').attr('action', '{{ url('account-manager/client/preferred-hotel') }}/' + id);
